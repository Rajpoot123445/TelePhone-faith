  ...
  return (
    <div className="main-page">
      ...
      <section className="main-page__hero">
        <div className="main-page__hero-content space-y-12">
          <h1 className="text-4xl font-semibold font-sans text-transparent bg-clip-text bg-gradient-to-t from-[#c6117d] to-[#e50471]">A Landline For Your Mobile</h1>
          <p className="text-2xl font-sans font-thin leading-9">
            Our Virtual Phone Numbers give you a <span className="text-2xl font-sans text-transparent bg-clip-text bg-gradient-to-t from-[#c6117d] to-[#e50471]"> Local (01/02) , 0800, 0333 or
              0300 </span> number that can be sent to your existing landline or mobile
      ...
      <section className="main-page__features">
        ...
        <div className="w-full flex flex-col md:flex-row gap-5 px-6 text-left">
          <div className="w-full md:w-[65%] flex flex-col gap-7 px-9 py-2">
            <div className="flex md:flex-row flex-col gap-9">
              <div className="w-full md:w-[50%] space-y-3 border px-6 py-5 bg-white rounded-md shadow-md">
                ...
                <p className="text-2xl md:text-xl font-sans font-thin px-4">Play a welcome announcement before the call is connected.</p>
              </div>
              <div className="w-full md:w-[50%] space-y-3 border px-6 py-5 bg-white rounded-md shadow-md">
                <div className="flex px-2 ">
                  <CiMicrophoneOn className="text-4xl text-[#c6117d]" />
      ...
      <section className="main-page__premium">
        ...
        <div className="w-full h-auto md:h-96 flex flex-col md:flex-row gap-5 px-6 text-left">
          <div className="w-full md:w-[35%] flex justify-center items-center">
            <img
      ...
      <section className="main-page__testimonials">
        ...
        <div className="flex flex-col md:flex-row justify-end items-center gap-24">
          <img
            ...
            className="h-7 mt-8 md:mt-0 md:w-[42%]"
          />
